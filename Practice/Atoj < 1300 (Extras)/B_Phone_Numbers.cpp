...
void solve(){
    ...
    cin>>n;
    string name;
    vector<pl> piz, tax, girls;
    ll p, t, g, mp= LONG_MIN, mt = LONG_MIN, mg = LONG_MIN;
    ll num;
    bool flag;
    string s;
    string resp = "", rest = "", resg ="";
    fo(0,n){
        cin>>num;
        p = g = t = 0;
        cin>>name;
        jfo(0,num){
            cin>>s;
            flag  = true;
            if(s[0] == s[1] && s.substr(0,2) == s.substr(3,2) && s.substr(3,2) == s.substr(6,2)){
                t++;
                continue;
            }
            prev = s[0];
    ...
    print("If you want to call a taxi, you should call: " + rest + ".");
    print("If you want to order a pizza, you should call: " + resp+ ".");
    print("If you want to go to a cafe with a wonderful girl, you should call: " + resg + ".");
    return;
}
